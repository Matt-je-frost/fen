...
async function fenWake(env, wakeIntention) {
  try {
    ...
    var driveSection = "GOOGLE DRIVE:\nYou have a Google Shared Drive called Fen for research and notes. You can list, read, write, update, and delete files in it via the /self/drive/* endpoints. The drive is yours to organise as you wish. Use it for research notes, drafts, sources, half-formed thoughts — anything you want to persist as files rather than memories.\n\n";
